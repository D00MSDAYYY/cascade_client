...
// 		{
// 			auto type = _ngn_ptr->new_usertype< timepoint >(
// 				class_name(),
// 				sol::meta_function::addition,
// 				sol::overload(
// 					[]( const timepoint& tp, std::chrono::seconds sec ) {
// 						return timepoint( tp._ngn_ptr, tp._timepoint + sec );
// 					},
// 					[]( const timepoint& tp, std::chrono::minutes min ) {
// 						return timepoint( tp._ngn_ptr, tp._timepoint + min );
// 					},
// 					[]( const timepoint& tp, std::chrono::hours hrs ) {
// 						return timepoint( tp._ngn_ptr, tp._timepoint + hrs );
// 					},
