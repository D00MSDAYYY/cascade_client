	...
	: QMainWindow{parent}
{
	...
	for(const auto& [str, func]:
		std::vector<std::pair<std::string, std::function<void()>>>{
			{"add", std::bind(&logbook_page::addConnection, this)},
			{"remove", std::bind(&logbook_page::removeConnection, this)},
			{"|", []() { return; }},
			{"resume", []() { return; }},
			{"suspend", []() { return; }}
	 })
...
void
logbook_page::_redistributeWidgets()
{
