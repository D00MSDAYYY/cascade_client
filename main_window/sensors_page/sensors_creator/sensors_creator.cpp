	...
	: QDialog(parent)
{
	...
	// /////////////////////////////////////////////////
	stndrd_tmplts_cmb->addItem("Temperature");	// TODO change qcombobox to tree-like (directory) structure
	...
	auto txt_md_btn{
		new QRadioButton{
						 "Text", this}
	 };	 // TODO replace preview widget for sensor visualization by qscroll area for text mode
