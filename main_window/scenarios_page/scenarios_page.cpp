	...
	: QMainWindow{parent}
{
	...
	for(const auto& [str, func]:
		std::vector<std::pair<std::string, std::function<void()>>>{
			{"add", std::bind(&scenarios_page::addConnection, this)},
			{"remove", std::bind(&scenarios_page::removeConnection, this)},
			{"select", []() { return; }},
			{"|", []() { return; }},
			{"resume", []() { return; }},
			{"suspend", []() { return; }}
...
void
scenarios_page::removeConnection()
{
...
void
scenarios_page::_redistributeWidgets()
{
